...
#if __has_include(<country_detector/CountryDetectorPlugin.h>)
#import <country_detector/CountryDetectorPlugin.h>
#else
...
+ (void)registerWithRegistry:(NSObject<FlutterPluginRegistry>*)registry {
  ...
  [CountryDetectorPlugin registerWithRegistrar:[registry registrarForPlugin:@"CountryDetectorPlugin"]];
